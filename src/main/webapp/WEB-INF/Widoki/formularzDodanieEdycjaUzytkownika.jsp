	...
	<header>
	    ...
	    <div class="jumbotron vertical-center">
	 		<div class ="container">
			    <div class="panel-heading panel"><span class="naglowek-napis">Dodaj / edytuj użytkownika</span></div>
		 			<form:form method="POST" modelAttribute="uzytkownik" class="form-horizontal">
						...
						<div class="row">
							...
							<label class="col-md-3 control-lable" for="firstName">Imię:</label>
								<div class="col-md-3">
								<form:input type="text" path="imie" id="firstName" class="form-control input-sm"/>
									<div class="has-error">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						...
						<div class="col-md-3">
							<form:input type="text" path="nazwisko" id="lastName" class="form-control input-sm" />
							<div class="has-error">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						<label class="col-md-3 control-lable dataUrodzeniaLabel" for="dataUrodzenia">Data urodzenia:</label>
					
						<div class="col-xs-2 dataUrodzenia ">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						...
						<div class="col-md-3">
							<form:input type="text" path="ulica" id="ulica" class="form-control input-sm" />
							<div class="has-error">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						...
						<div class="col-md-3">
							<form:input type="text" path="numerDomuMieszkania" id="numerDomuMieszkania" class="form-control input-sm" />
							<div class="has-error">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						<label class="col-md-3 control-lable" for="kodPocztowy">Kod pocztowy:</label>
						<div class="col-md-3">
							<form:input type="text" path="kodPocztowy" id="kodPocztowy" class="form-control input-sm" placeholder="nn-nnn" />
							<div class="has-error">
					...
					<div class="row">
					<div class="form-group formularz col-md-12">
						<label class="col-md-3 control-lable" for="numerTelefonu">Numer telefonu:</label>
						<div class="col-md-3">
							<form:input type="text" path="numerTelefonu" id="numerTelefonu" class="form-control input-sm" />
							<div class="has-error">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						...
						<div class="col-md-3">
							<c:choose>
								<c:when test="${edycja}">
									<form:input type="text" path="login" id="ssoId" class="form-control input-sm" disabled="true"/>
								</c:when>
								<c:otherwise>
									<form:input type="text"  path="login" id="ssoId" class="form-control input-sm" />
									<div class="has-error">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						<label class="col-md-3 control-lable" for="powtorzHaslo">Powtórz hasło:</label>
						<div class="col-md-3">
				...
				<div class="row">
					<div class="form-group formularz col-md-12">
						...
						<div class="col-md-3">
							<form:select path="uprawnienia" items="${role}" multiple="true" itemValue="identyfikator" itemLabel="rodzajUprawnien" class="form-control input-sm" />
							<div class="has-error">
					...
					<div class="col-mg-4 text-center">
						<c:choose>
							<c:when test="${edycja}">
								<a class="btn btn-lg przyciskAnuluj btn-light"  href="<c:url value='/system' />">Wróć do panelu</a> <input type="submit" value="Aktualizuj" class="btn btn-lg przycisk btn-light"/>  
							</c:when>
							<c:otherwise>
							<a class="btn btn-lg przyciskAnuluj btn-light"  href="<c:url value='/system' />">Wróć do panelu</a>	<input type="submit" value="Dodaj" class="btn btn-lg przycisk btn-light"/>  
							</c:otherwise>
						</c:choose>
					</div>
			</form:form>
