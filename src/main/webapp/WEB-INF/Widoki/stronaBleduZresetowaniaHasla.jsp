	  ...
	  <header>
	      <nav class="navbar navbar-expand-md navbar-dark fixed-top menu-nawigacyjne">
	       ...
	       <div class="jumbotron vertical-center">
	  	     <div class="panel-heading"><h1 class="naglowek-napis">Klucz umożliwiający zmianę hasła stracił ważność lub nie istnieje.</h1>
	  	     <div class="col-mg-4 text-center">
	  	     </div>
	  	     <a class="btn przycisk btn-lg btn-light" href="<c:url  value='/przypomnijHaslo' />">Spróbuj ponownie</a>
	 	  	</div>
	 	  	</div>
		</body>
	</html>