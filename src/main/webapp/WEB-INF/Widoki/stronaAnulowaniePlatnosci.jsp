	...
	<body>
		<header>
		 ...
		 <div class="jumbotron vertical-center">
	  	     <div class="panel-heading"><h1 class="naglowek-napis">Płatność się powiodła</h1>
	  	     <div class="col-mg-4 text-center">
	  	       <a class="btn przycisk btn-lg btn-light" href="<c:url  value='/' />">Przejdź na stronę główną</a>
	  	     </div>
	 	  	</div>
	 	 </div>
	</body>
