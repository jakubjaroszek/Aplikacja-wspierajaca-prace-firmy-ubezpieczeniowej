	...
	<body>
	  <header>
	      <nav class="navbar navbar-expand-xl navbar-dark fixed-top menu-nawigacyjne">
		    ...
		    <div class="panel-heading panel"><span class="naglowek-napis">Na podany adres e-mail został przesłany wygenerowany adres
		    umożliwiający zresetowanie hasła.</span></div>
	     </div>
	</body>
</html>